...
uses
  ...
  FMX.Controls.Presentation, FMX.StdCtrls, FMX.Objects, FMX.Layouts,Form_Login;
...
begin
caption:='ProvasOn';
Frm_Inicial.Height := Screen.Height;

  Frm_Inicial.Width := Screen.Width;
        //Trata_Slides(1);
end;
...
procedure TFrm_Inicial.Label3Click(Sender: TObject);
begin
layout_wizard.Visible:=false;
//layout_fundo.Visible:=true;
frm_login.Show;
freeandnil(Frm_Inicial);
end;



procedure TFrm_Inicial.Label4Click(Sender: TObject);
begin
layout_wizard.Visible:=false;
//layout_fundo.Visible:=true;
Form1.Show;
